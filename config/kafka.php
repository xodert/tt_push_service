...
return [
    ...
    /*
     | Dead Letter Queue topic. Malformed messages that cannot be processed
     | are forwarded here so the consumer is never blocked.
     | Set to null / leave empty to disable DLQ.
     */
